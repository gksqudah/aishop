...
<link rel="stylesheet" href="../resources/admin/blackList.css">
...
<body>
                ...
                <div class="admin_content_wrap">
                    <div class="admin_content_subject"><span>블랙리스트 관리</span></div>
	                    	...
	                    	<table class="member_table">
	                    		<thead>
	                    			<tr>
	                    				...
	                    				<td class="th_column_3">가입일</td>
	                    				<td class="th_column_4">MONEY($)</td>
	                    				<td class="th_column_5">POINT($)</td>
	                    				<td class="th_column_5">TEL</td>
	                    			</tr>
	                    		</thead>
                    ...
                    <div class="search_wrap">
                    	<form id="searchForm" action="/admin/memberManage" method="get">
                    		<div class="search_input">
                    			<input type="text" placeholder="이름검색" name="keyword" value='<c:out value="${pageMaker.cri.keyword}"></c:out>'>
                    ...
                    <%--페이지 이동후 pageMaker 데이터에있는 아래 값들 기본적으로 저장되도록 설정 --%>
...
$(document).ready(function(){
	...
	function checkResult(result){
		...
		alert("회원'${enroll_result}'을 등록하였습니다.");
	...
	if(delete_result == 1){
		...
		alert("해당 회원 데이터를 사용하고 있는 데이터가 있어서 삭제 할 수 없습니다.")
	}		
