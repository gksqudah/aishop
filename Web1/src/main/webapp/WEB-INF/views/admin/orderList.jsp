	                    	...
	                    	<table class="member_table">
	                    		<thead>
	                    			<tr>
	                    				...
	                    				<td class="th_column_2">주문ID</td>
	                    				<td class="th_column_4">주문일자</td>
	                    				<td class="th_column_3">연락처</td>
	                    				<td class="th_column_5">발송처리</td>
	                    			</tr>
	                    		</thead>
	                    		<c:forEach items="${orderList}" var="orderList">
	                    		<tr>
	                    			<td>
	                    				<a class="move" name="orderId" href='<c:out value="${orderList.orderId}"/>'>
	                    			...
	                    			<td><c:out value="${orderList.orderTel }"></c:out></td>
	                    			<td> 
	                    			
	                 <div class="deliveryChange">
						 <form role="form" method="post" class="deliveryForm" action="/admin/orderList">
...
$(".move").on("click", function(e){
	...
	moveForm.attr("action", "/admin/orderView");
	moveForm.submit();
