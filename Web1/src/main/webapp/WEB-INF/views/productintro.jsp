...
<head>
  ...
  <script type="text/javascript">
    console && console.log && console.log('ADI version 2.4706.0');
  </script>
  <script>
  ...
  <script type="text/javascript">
    ...
    ADI.getExperiments = function() {
      return {"specs.ob.pagePermissions":"true","specs.ob.fixMembersLoginCaching":"true","specs.ob.newAndUpdateKits":"true","specs.ob.waitForRenderEmpty":"true","specs.ob.med_oneAppDeepLinkWithOwnersAppDomain":"true","specs.ob.deprecateDsSeo":"true","specs.ob.reactIntro":"true","specs.ob.adiOfflineFormsMigration":"true","specs.ob.formTitles":"true","specs.ob.fixStorePresets":"true","specs.ob.syncMembersMenu":"true","specs.ob.addPageFromLinkPopup":"true","specs.ob.fixDeserializeWidget":"true","specs.ob.specs.ob.sectionHeightOSI":"true","specs.ob.removeGalleryFromSuggestions":"true","specs.ob.platformUseAppActive":"true","specs.ob.newResponsiveTopBar":"true","specs.ob.newContentManager":"true","specs.ob.proGallerySectionIndex":"true","specs.wossm.LimitNumOfFreeSites":"true","specs.ob.useSquidProxy":"true","specs.AdiMedReactIntroEnabled":"true","specs.ascend.AccessPackagePicker":"true","specs.ob.ckEditorInit":"true","specs.wos.SiteHistoryBM":"true","specs.ValidateAutopilotMigration":"true","specs.ob.usePlatformUninstall":"true","specs.ob.med_oneAppDeepLink":"true","specs.ob.TemplateFullStory":"true","specs.ob.ascendPanel":"true","specs.ob.footerColor":"true","specs.LimitContentSearchTerm":"true","specs.ob.hideSendFeedback":"true","specs.ob.squeezeAllContacts":"true","specs.ob.newDealerApi":"true","se_wixStores_ecomPlatformInstallation":"false","specs.ob.oldBlogRender":"true","specs.ob.pendingApps":"true","specs.ob.refComponentPoc":"true","specs.ob.lightbox":"true","specs.ob.liveVideoForWixEventsMigration":"true","specs.ob.lightboxSubscribeForm":"true","specs.ob.introRedirectToServiceOffer":"true","specs.ob.med_skipEditSectionPageToOwnerApp":"true","specs.ob.disableMMCustomTab":"true","specs.adi.EnableHardDeleteEvent":"true","specs.ob.useAddWidgetCallback":"true","specs.ob.MediaManagerMigration":"true","specs.experts.FeedBackNg2":"true","specs.UseBoltInPreviewForAdi":"true","specs.ob.pagePermissionsSiteMembers":"true","specs.ob.showPostPage":"true","specs.ob.encodeHTMLAgainstXSS":"true","specs.vod.siteBased":"true","specs.ob.handleSaveError":"true","specs.ob.tpaConfiguration":"false","specs.ob.platformsScreen4":"true","specs.CompressStoryEvents":"true","specs.ob.unsupportedTpa":"true","specs.ob.bookingsServicePageSettings":"true","specs.ob.newTopBarTpa":"true","specs.AdiIncreaseSelectTimeout":"true","specs.ob.mediaPreview":"true","specs.ob.forumDesignsPanel":"true","specs.ob.dontSaveAfterPublish":"true","specs.ob.med_blockPagesAddWithTPA":"true","specs.ob.AdiInstallBookCheckoutPage":"true","specs.ob.topBarNotificationsScrollBar":"true","specs.adi.PreferNonPrefixMatch":"false","specs.ob.med_menuMarketplaceLink":"true","specs.media.MediaManager3Migrate":"true","specs.vod.useGraphAPI":"false","specs.ob.wixEvents":"true","specs.ob.med_attachGoBackFunctionToWindowObject":"true","specs.ob.videoOsiActions":"true","specs.ob.lightboxInfra":"true","specs.ob.headlessPendingApps":"true","specs.ob.med_oneAppNewDeepLink":"true","specs.funnel.EnableNewCreateSiteUrl":"true","specs.ob.focalPointOSI":"true","specs.ob.videoUploader":"true","specs.ob.challengesTPAIntegration":"true","specs.ob.Migrate_MediaManager_Uploader":"true","specs.ob.blogGoToEditor":"true","specs.media.MediaManager3":"true","specs.ob.deleteAdiIntro":"true","specs.ob.med_businessQuestions":"false","specs.ob.lightboxSubscribeFormInfra":"true","specs.ob.med_videoUploader":"true","specs.ob.bookingsPlatformAPI":"true","specs.ob.newBusinessQuestions":"false","specs.ob.restaurantPreChecked":"true"};
    };
      ...
      if (!silentBI) {
        ...
        if (!ADI.headlessApi) {
          (new Image()).src = '//frog.wix.com/onboarding?src=66&evid=135&origin=home' +
              ...
              '&esi=39bebccd-8a73-44ed-b953-fcfeff299ba7';
  ...
  <script type="text/javascript">
    ...
    ADI.videoLoaderSrc = 'https://static.parastorage.com/services/adi-web/2.4706.0/assets/videos/loader.mp4';
  ...
  <!--  -->
    <link rel="stylesheet" href="https://static.parastorage.com/services/adi-web/2.4706.0/intro-react-js.min.css">
  <!-- reactIntro  -->

  <link rel="stylesheet" href="https://static.parastorage.com/services/adi-web/2.4706.0/first-parties-css.min.css">

  <link rel="stylesheet" href="https://static.parastorage.com/services/adi-web/2.4706.0/fonts2-css.min.css">
...
<script type="text/javascript">
  (function (window) {
    ...
    url += '&editorSessionId=39bebccd-8a73-44ed-b953-fcfeff299ba7';
    ADI.storyCache = {};
...
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/third-parties-clean-js.bundle.min.js"></script>
<!--  -->
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/second-parties-js.bundle.min.js"></script>
...
<script>
  ADI.clientTopology = {
    ...
    staticsVersion: '2.4706.0',
    staticsUrl: 'https://static.parastorage.com/services/adi-web/2.4706.0/',
    ...
    mediaManagerPartialsUrlG6: 'https://www.wix.com/_partials/media-manager-g6/1.1775.0/',
    santaEditorStaticsUrl: '//static.parastorage.com/services/santa-editor/1.12817.0/',
  };
</script>

<!--  -->
  <script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/intro-react-js.bundle.min.js"></script>
<!-- reactIntro  -->

<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/first-parties-js.bundle.min.js"></script>
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/assets/locale/messages_ko.js"></script>
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/assets/common-controls/locale/messages_ko.js"></script>
<script crossorigin="anonymous" src="https://static.parastorage.com/services/adi-web/2.4706.0/assets/organize-media/locale/messages_ko.js"></script>
...
<script>
  ...
  <ng-include
      src="'https://static.parastorage.com/services/adi-web/2.4706.0/assets/common-controls/svg-sprites-complex/icons.sprite.svg'"></ng-include>
    <ng-include
      src="'https://static.parastorage.com/services/adi-web/2.4706.0/assets/common-controls/svg-sprites/icons.sprite.svg'"></ng-include>
  </div>
  ...
  <script>ADI.lazyLoadCss('https://static.parastorage.com/services/adi-web/2.4706.0/third-parties-css.min.css');</script>
  <script>ADI.lazyLoadCss('https://static.parastorage.com/services/adi-web/2.4706.0/first-parties-js.min.css');</script>
</body>
</html>
